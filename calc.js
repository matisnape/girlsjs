...
document.getElementById("screen").innerHTML = "blpb"

/** nadpisuje wartość przez 0 */
function reset() {
  currentNumber = "0";
...
document.querySelector("#number1")
  .addEventListener( 'click', function() { numberKeyPressed("1")});
document.querySelector("#number2")
  .addEventListener( 'click', function() { numberKeyPressed("2")});
document.querySelector("#number3")
  .addEventListener( 'click', function() { numberKeyPressed("3")});
document.querySelector("#number4")
  .addEventListener( 'click', function() { numberKeyPressed("4")});
document.querySelector("#number5")
  .addEventListener( 'click', function() { numberKeyPressed("5")});
document.querySelector("#number6")
  .addEventListener( 'click', function() { numberKeyPressed("6")});
document.querySelector("#number7")
  .addEventListener( 'click', function() { numberKeyPressed("7")});
document.querySelector("#number8")
  .addEventListener( 'click', function() { numberKeyPressed("8")});
document.querySelector("#number9")
  .addEventListener( 'click', function() { numberKeyPressed("9")});
document.querySelector("#number0")
  .addEventListener( 'click', function() { numberKeyPressed("0")});
